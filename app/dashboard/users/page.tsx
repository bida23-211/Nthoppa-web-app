...
function UsersManagementContent() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "active":
        return <Badge className="bg-[#E9521C] text-white border-none">Active</Badge>;
      case "pending":
                  ...
                  <tr>
                    <th className="text-left py-3 px-4 text-sm font-medium text-gray-600">
                      <button
                        ...
                        className="flex items-center gap-1 hover:text-[#E9521C]"
                      >
                        Customer
                        ...
                        <td className="py-3 px-4">
                          <div className="flex items-center gap-1">
                            <button
                              ...
                              className="p-1.5 rounded-lg hover:bg-gray-100 text-gray-500 hover:text-[#E9521C] transition-colors"
                              title="Call"
                            >
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="font-semibold text-black mb-2 flex items-center gap-2">
                    <UserIcon className="h-4 w-4 text-[#E9521C]" />
                    Personal Information
                  </h4>
                ...
                <div>
                  <h4 className="font-semibold text-black mb-2 flex items-center gap-2">
                    <Briefcase className="h-4 w-4 text-[#E9521C]" />
                    Professional Information
                  </h4>
                  <div className="grid grid-cols-2 gap-3 text-sm p-3 bg-gray-50 rounded-lg">
                    <div>
                ...
                {selectedUser.interests && selectedUser.interests.length > 0 && (
                  <div>
                    <h4 className="font-semibold text-black mb-2 flex items-center gap-2">
                      <Star className="h-4 w-4 text-[#E9521C]" />
                      Areas of Interest
                    </h4>
