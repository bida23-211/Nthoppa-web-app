                ...
                <Card className="border-gray-200">
                  ...
                  <CardContent className="text-center">
                    <div className="relative inline-block">
                      <Avatar className="h-24 w-24 bg-gradient-to-r from-[#E9521C] to-black mx-auto">
              ...
              <Card className="border-gray-200">
                ...
                <CardContent>
                  <Button
                    ...
                    className="w-full border-gray-200 bg-white text-black hover:bg-[#E9521C] hover:text-white"
                  >
          ...
          <TabsContent value="notifications">
            <Card className="border-gray-200">
              ...
              <CardContent className="space-y-4">
                ...
                <Button onClick={handleNotificationSave} className="w-full bg-[#E9521C] text-white hover:bg-black">
                  <Save className="h-4 w-4 mr-2" />
          ...
          <TabsContent value="preferences">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card className="border-gray-200">
                <CardHeader>
                  <CardTitle className="text-black flex items-center gap-2">
                    <Languages className="h-5 w-5 text-[#E9521C]" />
                    Language
                  </CardTitle>
              ...
              <Card className="border-gray-200">
                <CardHeader>
                  <CardTitle className="text-black flex items-center gap-2">
                    {theme === "light" ? <Sun className="h-5 w-5 text-[#E9521C]" /> : theme === "dark" ? <Moon className="h-5 w-5 text-[#E9521C]" /> : <Laptop className="h-5 w-5 text-[#E9521C]" />}
                    Theme
                  </CardTitle>
              ...
              <Card className="border-gray-200">
                <CardHeader>
                  <CardTitle className="text-black flex items-center gap-2">
                    <Clock className="h-5 w-5 text-[#E9521C]" />
                    Timezone
                  </CardTitle>
              ...
              <Card className="border-gray-200">
                <CardHeader>
                  <CardTitle className="text-black flex items-center gap-2">
                    <DollarSign className="h-5 w-5 text-[#E9521C]" />
                    Currency
                  </CardTitle>
            ...
            <div className="mt-6 flex justify-end">
              <Button onClick={handlePreferencesSave} className="bg-[#E9521C] text-white hover:bg-black">
                <Save className="h-4 w-4 mr-2" />
                Save Preferences
              </Button>
            </div>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex gap-3 mt-6">
              ...
              <Button onClick={handleChangePassword} className="flex-1 bg-[#E9521C] text-white hover:bg-black">
                Update Password
              </Button>
            </div>
          </motion.div>
