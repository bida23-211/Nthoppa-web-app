      ...
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-black mb-2 flex items-center gap-2">
            <Store className="h-8 w-8 text-[#E9521C]" />
            Merchant Account
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {[
            { icon: <QrCode className="h-6 w-6 text-[#E9521C]" />, title: 'QR Payments', desc: 'Accept payments via QR code instantly' },
            { icon: <CreditCard className="h-6 w-6 text-[#E9521C]" />, title: 'Card Acceptance', desc: 'Accept Visa, Mastercard and mobile money' },
            { icon: <TrendingUp className="h-6 w-6 text-[#E9521C]" />, title: 'Sales Analytics', desc: 'Track revenue and business trends' },
            { icon: <CheckCircle className="h-6 w-6 text-[#E9521C]" />, title: 'Instant Settlement', desc: 'Funds in your account same day' },
          ].map(f => (
        ...
        {step === 1 && (
          <Card className="border-gray-200 max-w-xl">
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={() => setStep(2)} disabled={!businessName || !businessType} className="w-full bg-[#E9521C] text-white hover:bg-black">Continue</Button>
            </CardContent>
          </Card>
        )}
          ...
          <Card className="border-gray-200 max-w-xl">
            ...
            <CardContent className="space-y-4">
              <div className="p-4 bg-gray-50 rounded-lg space-y-2 text-sm">
                ...
                <div className="flex justify-between"><span className="text-gray-500">Account Type</span><Badge className="bg-[#E9521C] text-white">Nthoppa Merchant</Badge></div>
              </div>
              <div className="flex gap-3">
                <Button variant="outline" onClick={() => setStep(1)} className="flex-1">Back</Button>
                <Button onClick={handleApply} className="flex-1 bg-[#E9521C] text-white hover:bg-black">Submit Application</Button>
              </div>
            </CardContent>
          </Card>
        )}
