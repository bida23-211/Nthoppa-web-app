...
export default function AnalyticsPage() {
  ...
  const getRankColor = (rank: number) => {
    switch (rank) {
      case 1: return "bg-[#E9521C] text-white";
        ...
        <Tabs defaultValue="overview" className="space-y-4">
          ...
          <TabsContent value="overview" className="space-y-4">
            <Card className="border-gray-200">
              <CardHeader>
                <CardTitle className="text-black flex items-center gap-2">
                  <LineChart className="h-5 w-5 text-[#E9521C]" />
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <AreaChart data={areaChartData}>
                    ...
                    <Tooltip />
                    <Legend />
                    <Area type="monotone" dataKey="registrations" name="Registrations" stackId="1" stroke="#E9521C" fill="#E9521C" fillOpacity={0.6} />
            ...
            <Card className="border-gray-200">
              <CardHeader>
                <CardTitle className="text-black flex items-center gap-2">
                  <BarChart3 className="h-5 w-5 text-[#E9521C]" />
                  Weekly Performance
                </CardTitle>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={weeklyPerformance}>
                    ...
                    <Bar dataKey="count" name="Registrations" fill="#E9521C" radius={[4, 4, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-200">
              <CardHeader>
                <CardTitle className="text-black flex items-center gap-2">
                  <PieChart className="h-5 w-5 text-[#E9521C]" />
                  Territory Breakdown
                </CardTitle>
          ...
          <TabsContent value="daily" className="space-y-4">
            <Card className="border-gray-200">
              <CardHeader>
                <CardTitle className="text-black flex items-center gap-2">
                  <Calendar className="h-5 w-5 text-[#E9521C]" />
          ...
          <TabsContent value="leaderboard" className="space-y-4">
                  ...
                  {leaderboard.map((agent) => (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <Avatar className="h-12 w-12 bg-gradient-to-r from-[#E9521C] to-black">
                      ...
                      <div className="text-right">
                        <div className="flex items-center gap-1 text-[#E9521C]">
            ...
            <Card className="border-gray-200">
              <CardHeader>
                <CardTitle className="text-black flex items-center gap-2">
                  <Activity className="h-5 w-5 text-[#E9521C]" />
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <div className="text-3xl font-bold text-[#E9521C]">
                  ...
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <div className="text-3xl font-bold text-[#E9521C]">{agents.filter(a => a.status === "active").length}</div>
        ...
        <Card className="border-gray-200 bg-gradient-to-r from-orange-50 to-gray-50">
          <CardContent className="p-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              <div>
                <Zap className="h-6 w-6 text-[#E9521C] mx-auto mb-2" />
              ...
              <div>
                <TrendingUp className="h-6 w-6 text-[#E9521C] mx-auto mb-2" />
