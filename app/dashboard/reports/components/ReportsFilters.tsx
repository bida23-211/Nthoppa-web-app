      ...
      <Card className="border-gray-200">
        <CardHeader>
          <CardTitle className="text-black flex items-center gap-2">
            <Filter className="h-5 w-5 text-[#E9521C]" />
            Report Options
          </CardTitle>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
              {QUICK_OPTIONS.map((opt) => (
                <Button
                  ...
                  className="border-gray-200 hover:border-[#E9521C] hover:text-[#E9521C]"
                >
                  {opt.label}
                </Button>
              ))}
          ...
          <Button
            ...
            className="w-full bg-[#E9521C] hover:bg-[#d4471a] text-white"
          >
            {isGenerating ? (
              <>
