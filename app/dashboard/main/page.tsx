...
function QuickAction({ title, description, icon, onClick, color }: QuickActionProps) {
  return (
    ...
    >
      ...
      <div className="flex items-center text-[#E9521C] text-sm font-bold group-hover:gap-2 gap-1 transition-all">
...
export default function AgentHomePage() {
  ...
  const getStatusBadge = (status: string) => {
    if (status === "active")
      return <Badge className="bg-[#E9521C] text-white border-none">Completed</Badge>;
    if (status === "pending")
      ...
      <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Card className="border-gray-200">
              <CardContent className="p-5">
                ...
                <p className="text-2xl font-bold text-[#E9521C]">{behaviourData.savingsAdopters}</p>
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <Button
              variant="ghost"
              className="text-[#E9521C] hover:text-black"
              onClick={() => router.push("/dashboard/users")}
            >
              View All
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-[#E9521C]/10 rounded-lg flex items-center justify-center">
                      <UserCheck className="h-4 w-4 text-[#E9521C]" />
                    </div>
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-[#E9521C]/10 rounded-lg flex items-center justify-center">
                      <CheckCircle className="h-4 w-4 text-[#E9521C]" />
                    </div>
