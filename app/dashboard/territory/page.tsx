...
export default function TerritoryPage() {
  ...
  const getLocationIcon = (index: number) => {
    switch (index) {
      case 0:
        return <Building2 className="h-5 w-5 text-[#E9521C]" />;
      case 1:
        return <ShoppingBag className="h-5 w-5 text-black" />;
      case 2:
        return <Train className="h-5 w-5 text-[#E9521C]" />;
      default:
    ...
    <DashboardLayout type="agent">
      <div className="space-y-6">
            ...
            <Card className="border-gray-200">
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="w-10 h-10 bg-[#E9521C]/10 rounded-lg flex items-center justify-center">
                    <CheckCircle className="h-5 w-5 text-[#E9521C]" />
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card className="border-gray-200 h-full">
              <CardHeader>
                <CardTitle className="text-black flex items-center gap-2">
                  <Map className="h-5 w-5 text-[#E9521C]" />
                  Territory Map
                </CardTitle>
              ...
              <CardContent>
                <div className="relative bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg h-96 flex items-center justify-center overflow-hidden">
                  <div className="absolute inset-0 opacity-10">
                    <div className="absolute top-10 left-10 w-20 h-20 border-2 border-[#E9521C] rounded-full animate-pulse" />
                    <div className="absolute top-32 left-40 w-16 h-16 border-2 border-black rounded-full animate-pulse delay-100" />
                    <div className="absolute bottom-20 right-20 w-24 h-24 border-2 border-[#E9521C] rounded-full animate-pulse delay-200" />
                  ...
                  {topLocations.slice(0, 3).map((loc, idx) => (
                    ...
                    >
                      <div className="relative">
                        <div className="w-4 h-4 bg-[#E9521C] rounded-full animate-bounce" />
                ...
                <div className="flex items-center justify-center gap-6 mt-4 text-xs">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 bg-[#E9521C] rounded-full" />
          ...
          <div>
            <Card className="border-gray-200">
              <CardHeader>
                <CardTitle className="text-black flex items-center gap-2">
                  <Route className="h-5 w-5 text-[#E9521C]" />
                  Route Planner
                </CardTitle>
              ...
              <CardContent className="space-y-4">
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-[#E9521C] to-black text-white"
                >
                  {isGeneratingRoute ? (
                    <>
                  ...
                  <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-3 mt-4">
                    <div className="p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-bold text-[#E9521C]">{routeInfo.potentialRegistrations}</span>
                      </div>
                    </div>
        ...
        <Card className="border-gray-200">
          <CardHeader>
            <CardTitle className="text-black flex items-center gap-2">
              <Star className="h-5 w-5 text-[#E9521C]" />
                ...
                <motion.div
                  ...
                  className={`flex items-center justify-between p-3 rounded-lg cursor-pointer transition-all ${
                    selectedLocation === location.name
                      ? "bg-[#E9521C]/10 border border-[#E9521C]"
        ...
        <Card className="border-gray-200 bg-gradient-to-r from-orange-50 to-gray-50">
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-gradient-to-r from-[#E9521C] to-black rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 bg-white rounded-full flex items-center justify-center">
                      <Calendar className="h-3 w-3 text-[#E9521C]" />
                    </div>
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 bg-white rounded-full flex items-center justify-center">
                      <CheckCircle className="h-3 w-3 text-[#E9521C]" />
                    </div>
