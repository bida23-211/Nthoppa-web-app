        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-3">
            ...
            {loading ? (
              <div className="flex items-center justify-center h-32">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#E9521C]" />
              </div>
            ) : (
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        {isSelected && <CheckCircle2 className="h-5 w-5 text-[#E9521C] flex-shrink-0" />}
                      </div>
                    </div>
                  );
                })}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl text-black placeholder-gray-400 focus:outline-none focus:border-[#E9521C] bg-white"
                />
              </div>
              <div>
            ...
            <Button
              ...
              className="w-full bg-[#E9521C] hover:bg-black text-white py-3 text-base font-semibold"
            >
