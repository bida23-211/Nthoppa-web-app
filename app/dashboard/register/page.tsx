            ...
            <CardContent className="pt-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  ...
                  className="border-black text-black hover:bg-[#E9521C] hover:text-white hover:border-[#E9521C]"
                >
                  Back to Dashboard
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex justify-between mb-2 text-sm">
            <span className={cn(step >= 1 ? "text-[#E9521C]" : "text-gray-400")}>Personal Info</span>
            <span className={cn(step >= 2 ? "text-[#E9521C]" : "text-gray-400")}>Professional</span>
            <span className={cn(step >= 3 ? "text-[#E9521C]" : "text-gray-400")}>Interests</span>
            <span className={cn(step >= 4 ? "text-[#E9521C]" : "text-gray-400")}>Review</span>
          </div>
          ...
          {step === 3 && (
            ...
            >
              <Card className="border-gray-200">
                <CardHeader>
                  <CardTitle className="text-black flex items-center gap-2">
                    <Heart className="h-5 w-5 text-[#E9521C]" />
                    Areas of Interest
                  </CardTitle>
                      ...
                      return (
                        <div
                          ...
                          className={cn(
                            ...
                            isSelected
                              ? "border-[#E9521C] bg-[#E9521C]/5"
                              : "border-gray-200 hover:border-gray-300"
                          )}
                        >
                          <div className={cn(
                            "w-10 h-10 rounded-lg flex items-center justify-center",
                            isSelected ? "bg-[#E9521C]" : "bg-gray-100"
                          )}>
                            <Icon className={cn("h-5 w-5", isSelected ? "text-white" : "text-gray-500")} />
                          </div>
                          <span className={cn("font-medium", isSelected ? "text-[#E9521C]" : "text-black")}>
                            {interest.label}
                          </span>
                          {isSelected && <CheckCircle className="h-5 w-5 text-[#E9521C] ml-auto" />}
                        </div>
                      );
                    })}
                  </div>
          ...
          {step === 4 && (
            ...
            >
              <Card className="border-gray-200">
                <CardHeader>
                  <CardTitle className="text-black flex items-center gap-2">
                    <CheckSquare className="h-5 w-5 text-[#E9521C]" />
                    Review & Consent
                  </CardTitle>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {formData.interests.map(interest => (
                        <Badge key={interest} className="bg-[#E9521C] text-white">
                          {interest}
                        </Badge>
                      ))}
                    </div>
                  ...
                  <div className="space-y-3">
                    <h3 className="font-semibold text-black flex items-center gap-2">
                      <Bell className="h-4 w-4 text-[#E9521C]" />
                      Notification Preferences
                    </h3>
                    <div className="space-y-3">
                  ...
                  <div className="space-y-3 p-4 bg-gray-50 rounded-lg">
                    <h3 className="font-semibold text-black flex items-center gap-2">
                      <Shield className="h-4 w-4 text-[#E9521C]" />
                      Privacy & Data Consent *
                    </h3>
                    ...
                    <label className="flex items-start gap-3 cursor-pointer">
                      <input
                        ...
                        className="mt-1 h-4 w-4 rounded border-gray-300 text-[#E9521C] focus:ring-[#E9521C]"
                      />
        ...
        <div className="flex justify-between mt-6">
          ...
          {step < 4 ? (
            <Button onClick={nextStep} className="bg-[#E9521C] text-white hover:bg-black">
              Next
              <ChevronRight className="h-4 w-4 ml-2" />
            </Button>
          ) : (
            <Button onClick={handleSubmit} disabled={isSaving} className="bg-[#E9521C] text-white hover:bg-black">
              {isSaving ? (
                <>
