...
const pipelineData = [
  { stage: "Informal Traders", count: 12480, pct: 100, color: "bg-[#E9521C]" },
        ...
        <Card className="border-gray-200">
          <CardHeader>
            <CardTitle className="text-black flex items-center gap-2">
              <TrendingUp className="h-5 w-5 text-[#E9521C]" />
                  ...
                  <div key={trader.id} className="flex items-center justify-between p-4 hover:bg-gray-50 transition-colors">
                    <div className="flex items-center gap-3">
                      <Avatar className="h-10 w-10">
                        <AvatarFallback className="bg-gradient-to-br from-[#E9521C] to-[#c44216] text-white">
                          {trader.initials}
                        </AvatarFallback>
                      </Avatar>
                      <div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Button variant="ghost" size="sm" className="text-[#E9521C]">
        ...
        <Card className="border-gray-200 bg-gradient-to-r from-orange-50 to-gray-50">
          <CardContent className="p-6">
            <div className="flex items-center justify-between flex-wrap gap-4">
              ...
              <Button className="bg-[#E9521C] hover:bg-black text-white px-6">
                Learn More
