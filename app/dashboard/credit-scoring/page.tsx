      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <CardContent>
              <div className="grid grid-cols-3 gap-3 mb-6">
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <p className="text-2xl font-bold text-[#E9521C]">{creditYameData.totalProfiles.toLocaleString()}</p>
          ...
          <Card className="border-gray-200">
            <CardHeader>
              <CardTitle className="text-black flex items-center gap-2">
                <Store className="h-5 w-5 text-[#E9521C]" />
            ...
            <CardContent>
              <div className="grid grid-cols-3 gap-3 mb-6">
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <p className="text-2xl font-bold text-[#E9521C]">{iPachiData.totalProfiles.toLocaleString()}</p>
              ...
              {behaviourMetrics.map((metric, i) => (
                <div key={i} className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-bold text-[#E9521C]">{metric.pct}%</span>
                  </div>
        ...
        <Card className="border-gray-200 bg-gradient-to-r from-blue-50 to-orange-50">
          <CardContent className="p-6">
            <div className="flex items-center justify-between flex-wrap gap-4">
              ...
              <Badge className="bg-[#E9521C] text-white px-4 py-2">Coming Soon</Badge>
            </div>
          </CardContent>
        </Card>
      </div>
