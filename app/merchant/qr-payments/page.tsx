...
export default function MerchantQRPaymentsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-black flex items-center gap-2"><QrCode className="h-6 w-6 text-[#E9521C]" />QR Payments</h1>
