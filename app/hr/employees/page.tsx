  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button className="bg-[#E9521C] text-white hover:bg-black" onClick={() => toast({ title: "Coming Soon", description: "Employee onboarding form" })}>
          + Add Employee
        </Button>
      </div>
          ...
          <Card key={emp.id} className="border-gray-200">
            <CardContent className="p-5">
              ...
              <div className="flex gap-2">
                ...
                <Button variant="outline" size="sm" className="border-[#E9521C] text-[#E9521C] hover:bg-[#E9521C] hover:text-white">
                  Wellness Report
                </Button>
              </div>
            </CardContent>
