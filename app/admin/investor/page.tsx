...
export default function InvestorOverviewPage() {
  const metrics = [
    ...
    { label: "Users Onboarded (Demo)", value: "847", sub: "Across 3 territories", icon: <Users className="h-5 w-5 text-white" />, bg: "bg-[#E9521C]" },
  ...
  const pillars = [
    ...
    { title: "Behavioural Data Layer", desc: "Proprietary savings consistency, income tracking, and risk profiling data unavailable from traditional lenders.", progress: 74, color: "bg-[#E9521C]" },
      ...
      <div className="space-y-8">
        ...
        <div className="bg-gradient-to-br from-black to-gray-800 rounded-2xl p-8 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            <Badge className="bg-[#E9521C] text-white mb-4">Investor Overview</Badge>
        ...
        <Card className="border-gray-200">
          <CardContent className="p-6">
            <h2 className="text-xl font-bold text-black mb-4 flex items-center gap-2"><TrendingUp className="h-5 w-5 text-[#E9521C]" />Revenue Model</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                <div key={r.stream} className="p-4 bg-gray-50 rounded-xl">
                  ...
                  <p className="text-sm font-medium text-[#E9521C]">{r.model}</p>
                </div>
              ))}
            </div>
          </CardContent>
        ...
        <Card className="border-gray-200">
          <CardContent className="p-6">
            <h2 className="text-xl font-bold text-black mb-4 flex items-center gap-2"><BarChart3 className="h-5 w-5 text-[#E9521C]" />Growth Metrics</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <div key={g.metric} className="text-center p-3 bg-gray-50 rounded-xl">
                  ...
                  <p className="text-xl font-bold text-[#E9521C]">{g.value}</p>
