      ...
      <div className="space-y-6">
              ...
              <div className="h-64">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={weeklyData}>
                    ...
                    />
                    <Area type="monotone" dataKey="registrations" stroke="#E9521C" fill="url(#orangeGradient)" strokeWidth={2} />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
            </CardContent>
              ...
              <div className="h-64">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={weeklyData}>
                    ...
                    />
                    <Line type="monotone" dataKey="activeUsers" stroke="#E9521C" strokeWidth={2} dot={{ fill: "#E9521C", r: 4 }} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
            </CardContent>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-5">
            ...
            <button className="text-xs text-[#E9521C] font-semibold hover:underline">Export Data →</button>
          </div>
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-4">
                ...
                <div className="flex-1 h-2 bg-gray-100 rounded-full overflow-hidden">
                  <div className="h-full bg-[#E9521C] rounded-full transition-all duration-1000" style={{width: `${item.pct}%`}} />
                </div>
                <span className="text-[#E9521C] font-bold text-xs w-10 text-right">{item.pct}%</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="space-y-2">
              {[
                { stage: 'Informal Traders', count: '12,480', pct: 100, color: 'bg-[#E9521C]' },
        ...
        {/* NthoppaSure Section */}
        <div className="bg-gradient-to-br from-[#0a0a0a] to-[#1a1a1a] rounded-2xl p-6 shadow-sm border border-[#E9521C]/20">
          <div className="flex items-center justify-between mb-6">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <h3 className="font-semibold text-white text-base">NthoppaSure</h3>
                <span className="px-2 py-0.5 bg-[#E9521C]/20 text-[#E9521C] text-xs font-semibold rounded-full border border-[#E9521C]/30">Fintech Marketplace</span>
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            {[
              ...
              { label: 'Partner Products', value: '24', icon: '🏪', color: 'text-[#E9521C]' },
            ].map((stat, i) => (
          ...
          <div className="grid md:grid-cols-3 gap-3">
            {[
              ...
              <div key={i} className="bg-white/5 rounded-xl p-4 border border-white/5 hover:border-[#E9521C]/20 transition-colors">
                ...
                <div className="font-bold text-[#E9521C] text-xl">{item.active.toLocaleString()}</div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-5">
            ...
            <button 
              ...
              className="text-xs bg-[#E9521C] text-white font-semibold px-3 py-1.5 rounded-lg hover:bg-[#c44216] transition-colors"
            >
              + Add Merchant
            </button>
          </div>
