  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
        ...
        <button
          onClick={() => router.back()}
          className="inline-flex items-center gap-2 text-gray-500 hover:text-[#E9521C] font-medium text-sm group transition-colors"
        >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <select
              ...
              className="text-sm border border-gray-200 rounded-xl px-3 py-2 text-gray-600 bg-white focus:outline-none focus:border-[#E9521C]"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 bg-[#E9521C] hover:bg-[#c44216] text-white text-sm font-bold px-4 py-2 rounded-xl transition-colors"
            >
          ...
          {["overview", "growth", "revenue", "exports"].map((tab) => (
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all capitalize ${
                activeTab === tab
                  ? "bg-white text-[#E9521C] shadow-sm"
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button onClick={() => handleExport("User Growth CSV")} className="text-xs text-[#E9521C] hover:underline flex items-center gap-1"><Download className="h-3 w-3" />Export</button>
                </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button onClick={() => handleExport("Revenue CSV")} className="text-xs text-[#E9521C] hover:underline flex items-center gap-1"><Download className="h-3 w-3" />Export</button>
                </div>
                <ResponsiveContainer width="100%" height={200}>
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
                ...
                <div className="mt-4 pt-3 border-t border-gray-100">
                  <p className="text-xs text-gray-400">Overall conversion: <span className="font-bold text-[#E9521C]">6.9%</span> informal → business banking</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={() => handleExport("Registrations CSV")} className="flex items-center gap-1.5 text-xs text-[#E9521C] hover:underline">
          ...
          <div className="space-y-6">
                  ...
                  <div className="flex-1 space-y-3">
                    ...
                    <div className="pt-2 border-t border-gray-100">
                      <div className="flex justify-between">
                        ...
                        <span className="text-xs font-black text-[#E9521C]">BWP 284K</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-[#0a0a0a] rounded-2xl p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={() => handleExport("Stanbic Report PDF")} className="flex items-center gap-1.5 text-xs bg-[#E9521C] text-white px-3 py-1.5 rounded-lg hover:bg-[#c44216] transition-colors">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={i} className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-2xl font-black text-[#E9521C]">{s.value}</p>
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {reportTypes.map((report) => (
                <div key={report.id} className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm flex items-start gap-4 hover:border-[#E9521C]/30 hover:shadow-md transition-all group">
                  ...
                  <div className="flex flex-col gap-2 flex-shrink-0">
                    <button
                      ...
                      className="flex items-center gap-1.5 text-xs border border-gray-200 hover:border-[#E9521C] hover:text-[#E9521C] px-3 py-1.5 rounded-lg transition-colors text-gray-600"
                    >
                      <FileText className="h-3 w-3" /> CSV
                    </button>
                    <button
                      onClick={() => handleExport(`${report.label} (PDF)`)}
                      className="flex items-center gap-1.5 text-xs bg-[#E9521C] text-white px-3 py-1.5 rounded-lg hover:bg-[#c44216] transition-colors"
                    >
                      <Download className="h-3 w-3" /> PDF
                    </button>
                  </div>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm mt-6">
              <div className="flex items-center gap-2 mb-4">
                <Calendar className="h-4 w-4 text-[#E9521C]" />
