          ...
          <Card className="border-gray-200">
            <CardContent className="pt-8 text-center">
              <motion.div
                ...
                className="w-20 h-20 bg-gradient-to-br from-[#E9521C] to-[#c44216] rounded-full flex items-center justify-center mx-auto mb-6"
              >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button onClick={() => window.location.reload()} className="bg-[#E9521C] text-white hover:bg-black">
                  Register Another Merchant
                </Button>
                <Button variant="outline" onClick={() => router.push("/admin/dashboard")} className="border-black text-black hover:bg-[#E9521C] hover:text-white">
                  Back to Dashboard
                </Button>
              </div>
            </CardContent>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex justify-between mb-2 text-sm">
            <span className={cn(step >= 1 ? "text-[#E9521C]" : "text-gray-400")}>Business Info</span>
            <span className={cn(step >= 2 ? "text-[#E9521C]" : "text-gray-400")}>Contact & Banking</span>
            <span className={cn(step >= 3 ? "text-[#E9521C]" : "text-gray-400")}>Credentials</span>
          </div>
              ...
              <Card className="border-gray-200">
                <CardHeader>
                  <CardTitle className="text-black flex items-center gap-2">
                    <Building2 className="h-5 w-5 text-[#E9521C]" />
          ...
          {step === 2 && (
            <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.3 }}>
              <Card className="border-gray-200">
                <CardHeader>
                  <CardTitle className="text-black flex items-center gap-2">
                    <Briefcase className="h-5 w-5 text-[#E9521C]" />
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="border-t border-gray-200 pt-6">
                    <h3 className="font-semibold text-black mb-4 flex items-center gap-2"><Banknote className="h-4 w-4 text-[#E9521C]" />Banking Details</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
        ...
        <div className="flex justify-between mt-6">
          ...
          {step < 3 ? <Button onClick={nextStep} className="bg-[#E9521C] text-white hover:bg-black">Next<ChevronRight className="h-4 w-4 ml-2" /></Button> : <Button onClick={handleSubmit} disabled={isSaving} className="bg-[#E9521C] text-white hover:bg-black">{isSaving ? (<><div className="h-4 w-4 animate-spin rounded-full border-2 border-white border-t-transparent mr-2" />Registering...</>) : (<><CheckCircle className="h-4 w-4 mr-2" />Create Merchant Account</>)}</Button>}
        </div>
      </div>
    </AdminLayout>
  );
