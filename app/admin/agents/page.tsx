    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            { label: "Total Agents", value: agents.length, icon: <Users className="h-5 w-5 text-white" />, bg: "bg-black" },
            { label: "Active", value: activeCount, icon: <Shield className="h-5 w-5 text-white" />, bg: "bg-[#E9521C]" },
            { label: "Inactive", value: agents.length - activeCount, icon: <Users className="h-5 w-5 text-white" />, bg: "bg-gray-400" },
          ].map((s) => (
            <motion.div
              key={s.label}
              initial={{ opacity: 0, y: 10 }}
