          ...
          <Card className="border-gray-200">
            <CardContent className="pt-8 text-center">
              <motion.div
                ...
                className="w-20 h-20 bg-gradient-to-r from-[#E9521C] to-black rounded-full flex items-center justify-center mx-auto mb-6"
              >
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex justify-between mb-2 text-sm">
            <span className={step >= 1 ? "text-[#E9521C]" : "text-gray-400"}>Personal Info</span>
            <span className={step >= 2 ? "text-[#E9521C]" : "text-gray-400"}>Professional</span>
            <span className={step >= 3 ? "text-[#E9521C]" : "text-gray-400"}>Credentials</span>
          </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg mt-4">
                    <h3 className="font-semibold text-black mb-2 flex items-center gap-2">
                      <Award className="h-4 w-4 text-[#E9521C]" />
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="p-4 bg-orange-50 rounded-lg border border-orange-200 mt-4">
                    <div className="flex items-start gap-3">
                      <AlertCircle className="h-5 w-5 text-[#E9521C] mt-0.5" />
                      <div>
