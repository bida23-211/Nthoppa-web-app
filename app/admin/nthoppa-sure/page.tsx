            ...
            <div className="w-full flex flex-col items-center justify-end" style={{ height: 110 }}>
              <div
                ...
                style={{
                  ...
                  background: isCurrent ? ORANGE : "#e5e7eb",
                  transitionDelay: `${i * 80}ms`,
                }}
              />
            </div>
            <span className="text-[10px] font-medium" style={{ color: isCurrent ? ORANGE : "#9ca3af" }}>{d.month}</span>
          </div>
        );
      })}
    </div>
...
export default function AdminNthoppaSurePage() {
  ...
  const stats = [
    { label: "Active Policies", value: "3,240", change: "+8%", up: true, spark: [2840, 2980, 3050, 3100, 3180, 3240] },
    { label: "Total Premiums", value: "P 892K", change: "+12%", up: true, spark: [620, 710, 680, 750, 800, 892] },
    { label: "Claims This Month", value: "47", change: "-3%", up: false, spark: [38, 42, 55, 40, 44, 47] },
    { label: "Partner Products", value: "24", change: "+2", up: true, spark: [18, 19, 21, 22, 23, 24] },
  ];
      ...
      <div className="min-h-screen bg-[#f8f9fb]">
        ...
        <div className="bg-white border-b border-gray-100 px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="px-3 py-1 bg-orange-50 text-[#E9521C] text-xs font-semibold rounded-full border border-orange-100">
              Fintech Marketplace
            </span>
          </div>
        </div>
        ...
        <div className="px-8 py-6 max-w-7xl mx-auto space-y-5">
            ...
            {stats.map((s, i) => (
              <div key={i} className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5">
                ...
                <div className="flex items-center gap-1.5">
                  <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${s.up ? "bg-orange-50 text-[#E9521C]" : "bg-gray-100 text-gray-500"}`}>
                    {s.change}
                  </span>
            ...
            <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
              <div className="flex items-center justify-between mb-5">
                ...
                <div className="flex items-center gap-3 text-xs text-gray-400">
                  <span className="flex items-center gap-1.5"><span className="w-3 h-3 rounded bg-[#E9521C] inline-block" /> Mar</span>
                  <span className="flex items-center gap-1.5"><span className="w-3 h-3 rounded bg-gray-200 inline-block" /> Prior</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 mt-5 pt-4 border-t border-gray-50">
                <div>
                  ...
                  <p className="font-bold text-gray-800 text-sm">P 892K <span className="text-[#E9521C] font-normal text-xs">↑ Mar</span></p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-bold text-[#E9521C] text-sm">+43.9%</p>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-3">
                  <div>
                    <div className="flex items-center gap-1.5 mb-0.5">
                      <span className="w-2 h-2 rounded-full flex-shrink-0 bg-[#E9521C]" />
                  ...
                  <div>
                    <div className="flex items-center gap-1.5 mb-0.5">
                      <span className="w-2 h-2 rounded-full flex-shrink-0 bg-[#0f4c8a]" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    ...
                    <div key={i} className="px-6 py-3.5 grid grid-cols-12 items-center hover:bg-gray-50 transition-colors group">
                      <div className="col-span-5 flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <span className={`text-[10px] px-1.5 py-0.5 rounded-full font-semibold ${isStanbic ? "bg-blue-50 text-[#0f4c8a]" : "bg-orange-50 text-[#E9521C]"}`}>
                            {p.tag}
                          </span>
                        </div>
                      </div>
            ...
            <div className="flex flex-col gap-4">
              {/* Monthly summary */}
              <div className="bg-[#E9521C] rounded-2xl p-6 text-white shadow-lg shadow-orange-200">
                ...
                {claims.map((c, i) => (
                  <div key={i} className="mb-3 last:mb-0">
                    ...
                    <div className="h-1.5 bg-gray-100 rounded-full overflow-hidden">
                      <div className="h-full rounded-full transition-all duration-700 bg-[#E9521C]"
                        style={{ width: animated ? `${(c.value / 47) * 100}%` : "0%", opacity: 1 - i * 0.18, transitionDelay: `${i * 100}ms` }} />
                    </div>
                  </div>
                ))}
              </div>
