        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start">
            ...
            <div className="space-y-4">
              {[
                ...
                <motion.div key={i} initial={{opacity: 0, x: -20}} whileInView={{opacity: 1, x: 0}} viewport={{once: true}} transition={{delay: i * 0.1}}
                  className="flex items-start gap-4 p-4 rounded-2xl bg-white/5 hover:bg-white/8 transition-colors border border-white/5 hover:border-[#E9521C]/20 group"
                >
          ...
          <motion.div initial={{opacity: 0, y: 30}} whileInView={{opacity: 1, y: 0}} viewport={{once: true}} transition={{duration: 0.6, delay: 0.2}}>
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8">
              ...
              {[
                { stage: 'Informal Traders', value: 12480, pct: 100, color: 'bg-[#E9521C]' },
