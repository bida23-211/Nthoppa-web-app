  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`${collapsed ? 'lg:pl-16' : 'lg:pl-64'} transition-all duration-300`}>
        <header className={`fixed right-0 ${collapsed ? 'lg:left-16' : 'lg:left-64'} left-0 top-0 z-30 bg-white/90 backdrop-blur-md border-b border-gray-100 shadow-sm transition-all duration-300`}>
